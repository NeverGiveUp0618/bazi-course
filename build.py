...
QUIZ_SOURCES = [
    ...
    ('v课实录',     ['三·AB', '三·AC', '三·AD', '三·AE', '三·AF', '三·AG', '三·AH',
                     # ⭐ 2026-09-21 并入「中」「下」两本（v 766-876）：财运/寿命/牢狱/官运/六亲/子女/全盘
                     '三·AJ', '三·AK', '三·AL', '三·AM', '三·AN', '三·AO', '三·AP']),

    # ⭐ 2026-09-22 新增：2012 高级面授班现场笔记（102 页扫描件，例1–例191+）
    ('高级面授实录',   ['三·AR']),                          # 册 2012高级面授
...
# ⚠️ 资料 22 册，题库刻意不收的：17《刑冲破害的使用方法》（纯规则零命例、口径偏传统，见记忆）。
#    11《实战技巧》＝16 的扫描版；20＝2012面授（笔记14）；21＝六爻.pdf（三·AI）——都不是"没挖"。
...
def main():
    ...
    BASE = {'course': 16, 'notes': 22, 'quiz': 744, 'chart': 726, 'chai': 522}
